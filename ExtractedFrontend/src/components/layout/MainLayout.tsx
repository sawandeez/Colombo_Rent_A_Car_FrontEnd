...
import { Car, Mail, Phone, MapPin, Github, Twitter, Instagram } from 'lucide-react';

const Footer: React.FC = () => {
    return (
        <footer className="bg-surface-950 border-t border-white/5 pt-20 pb-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-surface-400">
                            ...
                            <li><a href="#" className="hover:text-primary-400 transition-colors">Insurance</a></li>
                        </ul>
                    </div>
                ...
                <div className="pt-8 border-t border-white/5 text-center text-surface-500 text-sm">
